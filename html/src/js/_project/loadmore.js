...
const load = {
	...
	$numberOfTwoColumnArticlesOnLoad: $('.js-two_column_article_container').data('on-load-number'),
	$twoColumnArticlesContainer: $('.js-two_column_article_container'),
	$numberOfThreeColumnArticlesOnLoad: $('.js-three_column_article_container').data('on-load-number'),
	$threeColumnArticlesContainer: $('.js-three_column_article_container'),
